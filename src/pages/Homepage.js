...
const Hompepage = () => {
  ...
  const Card = ({ icon, title, description, link }) => (
    <a href={link} className="block transition-shadow duration-300 bg-white rounded-lg shadow-md hover:shadow-lg">
      <div className="p-6">
          ...
          <div className="flex flex-col items-start space-y-6 lg:flex-row lg:space-y-0 lg:space-x-10">
            <div className="flex-1">
              ...
              <div className="mt-4 text-gray-700 welcome-copy">
                <p>
                  <strong>
                    We are so happy to welcome you to Elroy Foundation Primary School,
                    which serves a richly-diverse community.
                  </strong>
                </p>
                <p>
                  Elroy Foundation belongs to the Association of Trust Schools (ATS).
                  The Head and Board Members attend various gatherings,
                  meetings, and conferences to promote quality education within
                  our schools.
                </p>
                <p>
                  Elroy Foundation currently enrolls students from ECD up to Grade 7
                  for pupils between the ages of 3 to 13. As a member of ATS and
                  CHISZ, Elroy Foundation School shares the values and ethos of other
                  like-minded schools.
                </p>
              </div>
    ...
    <div className="mx-auto max-w-7xl">
      <div className="mb-12 text-center">
        ...
        <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
          At Elroy Foundation, learning is at the core<br /> of everything we do
        </h2>
        <p className="mt-4 text-xl text-gray-500">
          We are passionate about providing the opportunities to children which allow them to flourish later in life. This means that we support and challenge every single pupil to achieve their very best.
        </p>
      </div>
